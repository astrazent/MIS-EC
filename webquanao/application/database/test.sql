...
INSERT INTO `product` (`catalog_id`, `name`, `content`, `price`, `discount`, `image_link`, `image_list`, `view`, `buyed`, `rate_total`, `rate_count`, `created`) VALUES
...
(16, 'cổ trụ thắt nơ', '', '255000.00', 51000, 'hang-nhap-so-mi-nu-co-tru-that-no-sm1.jpg', '["hang-nhap-so-mi-nu-co-tru-that-no.jpg","hang-nhap-so-mi-nu-co-tru-that-no-sm125-1.jpg"]', 2, 1, 4, 1, 1493983674),
