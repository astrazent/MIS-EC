...
require_once APPPATH . 'third_party/php-jwt/Exceptions/InvalidClaimTypeException.php';
require_once APPPATH . 'third_party/php-jwt/Exceptions/InvalidStructureException.php';
require_once APPPATH . 'third_party/php-jwt/Exceptions/TokenExpiredException.php';
require_once APPPATH . 'third_party/php-jwt/Exceptions/TokenInactiveException.php';
require_once APPPATH . 'third_party/php-jwt/Exceptions/UndefinedAlgorithmException.php';
require_once APPPATH . 'third_party/php-jwt/Exceptions/InsecureTokenException.php';
require_once APPPATH . 'third_party/php-jwt/Exceptions/UnsupportedAlgorithmException.php';
require_once APPPATH . 'third_party/php-jwt/Exceptions/UnsupportedTokenTypeException.php';
